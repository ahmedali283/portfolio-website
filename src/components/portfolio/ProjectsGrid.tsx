      ...
      >
              ...
              <div className="absolute bottom-3 left-1/2 -translate-x-1/2 flex gap-1.5 z-10">
                {project.images!.map((_, i) => (
                  <button
                    ...
                    aria-label={`View screenshot ${i + 1}`}
                    className={`rounded-full transition-all duration-300 ${i === activeIndex ? 'w-4 h-1.5 bg-white' : 'w-1.5 h-1.5 bg-white/40 hover:bg-white/70'
                      }`}
                  />
                ))}
              </div>
        ...
        <div className="p-6 sm:p-8">
          ...
          <div className="mt-2">
            <a
              href="/book"
              className="inline-flex items-center justify-center w-full sm:w-auto gap-2 px-8 py-3.5 rounded-xl bg-gradient-to-r from-accent to-accent-teal text-white font-bold shadow-lg shadow-accent/25 hover:shadow-accent/40 hover:-translate-y-0.5 transition-all duration-300 group/cta"
            >
    ...
    <>
      ...
      >
        ...
        <div
          ...
          className="relative grid md:grid-cols-2 bg-divider/20 backdrop-blur-sm border border-divider/60 group-hover:border-transparent rounded-2xl overflow-hidden transition-all duration-500 cursor-pointer"
        >
          {/* Visual */}
            ...
            <div>
              ...
              <div className="flex flex-wrap items-center gap-3 sm:gap-4 mt-2">
                <button
                  ...
                  className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-divider/80 hover:bg-divider border border-divider/50 text-sm font-semibold text-primary transition-all duration-300"
                >
                  Read more
                </button>
                <a
                  href="/book"
                  onClick={(e) => e.stopPropagation()}
                  className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-gradient-to-r from-accent to-accent-teal text-white text-sm font-bold shadow-lg shadow-accent/25 hover:shadow-accent/40 hover:-translate-y-0.5 transition-all duration-300 group/cta"
                >
                  Start a Similar Project
                  <span className="transition-transform duration-300 group-hover/cta:translate-x-1.5">→</span>
                </a>
  ...
  return (
    <>
      ...
      >
        ...
        <div
          onClick={() => setShowModal(true)}
          className="relative flex flex-col h-full bg-divider/20 backdrop-blur-sm border border-divider/60 group-hover:border-transparent rounded-2xl overflow-hidden transition-all duration-500 cursor-pointer"
        >
          ...
          <div className="flex flex-col flex-1 p-6">
            ...
            {/* Actions */}
            <div className="mt-auto pt-5 border-t border-divider/40 flex flex-col gap-2.5">
              <button
                onClick={(e) => {
                  e.stopPropagation();
                  setShowModal(true);
                }}
                className="inline-flex items-center justify-center w-full gap-2 px-4 py-2.5 rounded-xl bg-divider/80 hover:bg-divider border border-divider/50 text-sm font-semibold text-primary transition-all duration-300"
              >
                Read more
              </button>
              <a
                href="/book"
                onClick={(e) => e.stopPropagation()}
                className="inline-flex items-center justify-center w-full gap-2 px-4 py-2.5 rounded-xl bg-gradient-to-r from-accent to-accent-teal text-white text-sm font-bold shadow-lg shadow-accent/20 hover:shadow-accent/40 transition-all duration-300 group/cta"
              >
                Start a Similar Project
